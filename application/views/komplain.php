...
<style type="text/css">
 ...
 <body>
	...
	<div class="services-breadcrumb">
		<div class="agile_inner_breadcrumb">
			<div class="container">
				<ul class="w3_short">
					<li>
						<a href="<?php echo base_url("C_login/") ?>">Home</a>
						<i>|</i>
					</li>
					<li>
	...
	<div class="container" style="padding: 50px">
 		<form method="post" action="<?php echo base_url("C_login/proses_tambah_komplain") ?>">
			<div class="input-group w3_w3layouts">
				<span class="input-group-addon" id="nama">Nama</span>
				<input type="text" class="form-control" name="nama_k" placeholder="Nama Pengguna" aria-describedby="basic-addon1">
			</div>
			<div class="input-group w3_w3layouts">
				<span class="input-group-addon" id="jenis">Komplain</span>
				<input type="text-area" class="form-control" name="kritik" placeholder="Komplain" aria-describedby="basic-addon1">
			</div>
